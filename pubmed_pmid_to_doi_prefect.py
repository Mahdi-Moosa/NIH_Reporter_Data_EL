...
@flow(
    log_prints=True,
    description="Subflow to download, uncompress, extract, save a parquet copy and delete file from single link.",
)
...
def batch_doi_fetch(
    ...
    start_index
    for lnk in xml_gz_links[start_index:start_index+5]:
